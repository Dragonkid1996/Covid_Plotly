...
#The funtion to convert the original time (in ms) to a date
def convertTime(t):
    t = int(t)
...
#Transform the data to just get what we need
...
#Aggregate the data to just get countries, rather than every individual town
...
#Get top 10 countries and numbers of confirmed, recovered and deaths
...
#Create the bar charts to show top ten countries
fig.add_trace(
    go.Bar(
        x = top10_countries_1,
        y = top10_confirmed,
